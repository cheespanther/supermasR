...
library("lubridate")
  ...
  dat <- lapply(datatickets, as.numeric)
  ...
  tablaresumen <- data.frame(numerodatos, combinedmean, ventastotales)
  ...
  write.csv(dat, file = "C:/Users/Iskar/Desktop/dat.csv")
  ...
  dataticketsclass <- class(datatickets)
  return (combinedmean)
